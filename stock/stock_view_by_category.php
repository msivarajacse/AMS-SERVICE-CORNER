...
$next=$page+1;
 ...
 $nextpage=" <a href='stock_view_by_category.php?page=$next&category=$category' class='btn btn-success '>Next   <span class='fa fa-arrow-right'></span> </a>";
 if($page==1){
      $previous="";
 }
 else{
      $previous=" <a href='stock_view_by_category.php?page=$prev&category=$category' class='btn btn-primary '><span class='fa fa-arrow-left'></span>  Previous</a>";
 } 
